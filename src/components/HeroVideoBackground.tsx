...
export default function HeroVideoBackground() {
  ...
  return (
    <div 
      className="absolute inset-0 w-full h-full overflow-hidden pointer-events-none transition-all duration-1000 bg-cream-50"
      style={{
        backgroundImage: `linear-gradient(180deg, rgba(253, 248, 240, 0.8) 0%, rgba(250, 245, 235, 0.6) 50%, rgba(253, 248, 240, 0.9) 100%), url('https://images.unsplash.com/photo-1608248597279-f99d160bfcbc?auto=format&fit=crop&q=80&w=1920')`,
    ...
    >
      ...
      <div 
        className="absolute inset-0 bg-gradient-to-b from-cream-50/70 via-cream-50/50 to-cream-100/80 z-0" 
